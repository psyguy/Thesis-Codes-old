...
latex_documents = [
  ('index', 'dipde.tex', u'dipde Documentation',
...
man_pages = [
    ('index', 'dipde', u'dipde Documentation',
...
texinfo_documents = [
  ('index', 'dipde', u'dipde Documentation',
   u'Allen Institute for Brain Science', 'dipde', 'One line description of project.',
   'Miscellaneous'),
]
